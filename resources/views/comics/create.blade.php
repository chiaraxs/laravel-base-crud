...
{{-- la funzione old() recupera il dato inviato all'array precedentemente, lo rende visibile dall'utente e modificabile --}}
@section('content')
    ...
    <div class="container d-flex justify-content-center mt-5">
        ...
        <form action="{{ route ('comics.store') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" placeholder="Insert Title" value="{{old('title')}}">
            </div>

            <div class="mb-3">
                <label for="thumb" class="form-label me-2">Thumb</label>
                <input type="text" name="thumb" placeholder="Insert Thumb" value="{{old('thumb')}}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="series" placeholder="Insert Series" value="{{old('series')}}">
            </div>

            <div class="mb-3">
                <label for="sale_date" class="form-label me-2">Sale Date</label>
                <input type="text" name="sale_date" placeholder="Insert Sale Date" value="{{old('sale_date')}}">
            </div>

            <div class="mb-3">
                <label for="type" class="form-label me-2">Type</label>
                <input type="text" name="type" placeholder="Insert Type" value="{{old('type')}}">
            </div>

            <div class="mb-3">
                <label for="description" class="form-label me-2">Description</label>
                <textarea class="form-control" name="description" placeholder="Insert Description" rows="3" value="{{old('description')}}"></textarea>
            </div>
